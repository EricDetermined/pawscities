          ...
          <FeatureGate currentTier={tier} featureName="Advanced Analytics">
            <div className="bg-white rounded-xl border p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <Link href="/business/analytics" className="text-sm text-orange-600 hover:text-orange-700 font-medium">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <ul className="space-y-1.5 text-sm">
                    ...
                    <li className="flex items-center gap-2 text-green-700">
                      <span className="text-green-500">&#10003;</span> Aggregate stats (views, clicks, CTR)
                    </li>
                  </ul>
                </div>
                <div className="border-t pt-3">
                  ...
                  <ul className="space-y-1.5 text-sm">
                    ...
                    <li className="flex items-center gap-2 text-gray-400">
                      ...
                      Analytics: date ranges, exports, activity feed
                    </li>
                  </ul>
                </div>
                <Link
