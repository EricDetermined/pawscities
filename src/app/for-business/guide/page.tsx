...
export default function BusinessGuidePublicPage() {
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-orange-600 via-orange-500 to-amber-500 text-white py-16 px-4">
        <div className="container mx-auto max-w-5xl text-center">
          <p className="text-sm font-medium text-orange-100 mb-3">
            <Link href="/for-business" className="hover:text-white underline">For Business</Link> &rarr; Guide
          </p>
          <h1 className="font-display text-3xl md:text-5xl font-bold mb-4">
            Business Owner Guide
          </h1>
          <p className="text-lg md:text-xl opacity-90 max-w-2xl mx-auto mb-6">
            Everything you need to know about managing and growing your dog-friendly business on Paw Cities.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            <Link
              href="/for-business"
              className="px-6 py-3 border-2 border-white/30 text-white rounded-xl font-bold hover:bg-white/10 transition-colors"
            >
              Learn More
            </Link>
          </div>
      ...
      <div className="container mx-auto max-w-5xl px-4 py-12">
        ...
        <div className="bg-white rounded-xl border p-6 sm:p-8">
              ...
              <div className="mb-6">
                ...
                <div className="space-y-1">
                  <Step number={1} title="Create a free account">
                    <Link href="/signup" className="text-orange-600 hover:underline">Sign up</Link> for Paw Cities in under a minute. No credit card required.
                  </Step>
                  <Step number={2} title="Search for your business">
                  ...
                  <Step number={5} title="Wait for approval">
          ...
          {activeSection === 'listing' && (
            <div>
              ...
              <p className="text-gray-600 mb-6">
                Keep your listing accurate and compelling to attract more dog-owning visitors.
              </p>
          ...
          {activeSection === 'photos' && (
            <div>
              ...
              <p className="text-gray-600 mb-6">
                Great photos make your listing stand out and attract more visitors.
              </p>
                ...
                <div>
                  ...
                  <div className="space-y-1">
                    <Step number={1} title="Go to the Photos page">
                      Click &ldquo;Photos&rdquo; in the sidebar navigation of your dashboard.
                    </Step>
          ...
          {activeSection === 'reviews' && (
            <div>
              ...
              <p className="text-gray-600 mb-6">
                Reviews are one of the most important factors for attracting new visitors.
              </p>
          ...
          {activeSection === 'analytics' && (
            <div>
              ...
              <p className="text-gray-600 mb-6">
                Track how your listing is performing and understand your audience.
              </p>
        ...
        {/* CTA Banner */}
        <div className="mt-10 bg-gradient-to-r from-orange-50 to-amber-50 border border-orange-200 rounded-xl p-8 text-center">
          <h3 className="text-xl font-bold text-gray-900 mb-2">Ready to get started?</h3>
          <p className="text-gray-600 mb-5">Claim your business listing for free and start reaching dog owners in your area today.</p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <Link
              href="/login?redirect=/business/claim"
