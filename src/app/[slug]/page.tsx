...
function dbToEstablishment(dbEst: Record<string, unknown>, citySlug: string, cityLat: number, cityLng: number): Establishment | null {
  ...
  return {
    ...
    descriptionEs: (dbEst.description_es as string) || undefined,
    descriptionJa: (dbEst.description_ja as string) || undefined,
    descriptionCa: (dbEst.description_ca as string) || undefined,
