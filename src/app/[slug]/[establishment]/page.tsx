        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 md:p-10">
          <div className="container mx-auto">
            <div className="flex flex-wrap items-center gap-2 mb-3">
              ...
              {place.isVerified && (
                <span className="bg-blue-500 text-white text-sm px-3 py-1 rounded-full font-medium">Verified</span>
              )}
              {place.isFeatured && (
                <span className="bg-amber-500 text-white text-sm px-3 py-1 rounded-full font-medium">Featured</span>
              )}
              {place.tier === 'premium' && (
                <span className="bg-purple-500 text-white text-sm px-3 py-1 rounded-full font-medium">Premium</span>
              )}
            </div>
