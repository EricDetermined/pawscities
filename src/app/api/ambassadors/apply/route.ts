  ...
  try {
    ...
    const { data, error } = await supabase
      ...
      .insert({
        ...
        handle_type: ['personal', 'dog_account'].includes(handleType) ? handleType : 'personal',
        dog_name: dogName?.trim() || null,
        announcement_preference: ['own_name', 'dog_name'].includes(announcementPreference) ? announcementPreference : 'own_name',
