  ...
  const res = await fetch('https://api.resend.com/emails', {
    ...
    body: JSON.stringify({
      ...
      html: `<div style="font-family:sans-serif;max-width:520px;margin:0 auto">
        ...
        <p style="margin:28px 0"><a href="${data.properties.action_link}" style="background:#ea580c;color:#fff;padding:12px 24px;border-radius:8px;text-decoration:none;font-weight:bold">Reset password</a></p>
