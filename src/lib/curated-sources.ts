...
export const CURATED_SOURCES: Record<string, CuratedSource[]> = {
  ...
  paris: [
    ...
    {
      url: 'https://www.eventbrite.fr/d/france--paris/chien/',
      name: 'Eventbrite Paris Chien',
      language: 'fr',
      linkPattern: '/e/',
      maxEvents: 6,
    },
  ...
  barcelona: [
    ...
    {
      url: 'https://www.eventbrite.es/d/spain--barcelona/mascotas/',
      name: 'Eventbrite Barcelona Mascotas',
      language: 'es',
      linkPattern: '/e/',
      maxEvents: 6,
    },
  ...
  tokyo: [
    ...
    {
      url: 'https://www.eventbrite.com/d/japan--tokyo/dog-events/',
      name: 'Eventbrite Tokyo Dogs',
      language: 'en',
      linkPattern: '/e/',
      maxEvents: 6,
    },
    {
      url: 'https://sippo.asahi.com/article/list/event',
      name: 'Sippo Events',
      language: 'ja',
      linkPattern: 'sippo\\.asahi\\.com/article/\\d+',
      maxEvents: 6,
    },
  ],
  sydney: [
  ...
  geneva: [
    ...
    {
      url: 'https://www.eventbrite.fr/d/switzerland--gen%C3%A8ve/chien/',
      name: 'Eventbrite Genève Chien',
      language: 'fr',
      linkPattern: '/e/',
      maxEvents: 6,
    },
