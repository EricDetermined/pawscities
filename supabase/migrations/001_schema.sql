...
INSERT INTO categories (slug, name, name_fr, icon, color, sort_order) VALUES
  ('restaurants', 'Restaurants', 'Restaurants', 'ð½ï¸', 'orange', 1),
  ('cafes', 'Cafes', 'CafÃ©s', 'â', 'brown', 2),
  ('hotels', 'Hotels', 'HÃ´tels', 'ð¨', 'blue', 3),
  ('parks', 'Dog Parks', 'Parcs', 'ð³', 'green', 4),
  ('beaches', 'Beaches', 'Plages', 'ðï¸', 'cyan', 5),
  ('vets', 'Vets', 'VÃ©tÃ©rinaires', 'ð¥', 'red', 6),
  ('groomers', 'Groomers', 'Toiletteurs', 'âï¸', 'pink', 7),
  ('shops', 'Pet Shops', 'Animaleries', 'ðª', 'purple', 8),
  ('activities', 'Activities', 'ActivitÃ©s', 'ð¾', 'yellow', 9),
...
INSERT INTO cities (slug, name, name_fr, country, country_code, timezone, currency, latitude, longitude, zoom_level, languages, description, description_fr, hero_image, is_active, emergency_vet_search, leash_required, off_leash_areas, public_transport, public_transport_fr) VALUES
  ('geneva', 'Geneva', 'GenÃ¨ve', 'Switzerland', 'CH', 'Europe/Zurich', 'CHF', 46.2044, 6.1432, 13, ARRAY['en','fr'], 'Discover dog-friendly parks, restaurants, hotels and more in Geneva. From Lake Geneva shores to the charming Old Town.', 'DÃ©couvrez les parcs, restaurants, hÃ´tels et plus accueillant les chiens Ã  GenÃ¨ve.', 'https://images.unsplash.com/photo-1573108037329-37aa135a142e?auto=format&fit=crop&w=1600&q=80', true, 'emergency vet Geneva Switzerland', true, true, 'Small dogs in carriers travel free. Larger dogs need a reduced-fare ticket.', 'Les petits chiens en transporteur voyagent gratuitement. Les grands chiens ont besoin d''un billet Ã  tarif rÃ©duit.'),
  ('paris', 'Paris', 'Paris', 'France', 'FR', 'Europe/Paris', 'EUR', 48.8566, 2.3522, 12, ARRAY['en','fr'], 'Explore dog-friendly cafÃ©s, parks, and restaurants in the City of Light. Paris loves dogs!', 'Explorez les cafÃ©s, parcs et restaurants accueillant les chiens dans la Ville LumiÃ¨re.', 'https://images.unsplash.com/photo-1502602898657-3e91760cbb34?auto=format&fit=crop&w=1600&q=80', true, 'urgence vÃ©tÃ©rinaire Paris France', true, true, 'Dogs allowed on metro and buses in carriers or on leash. Large dogs need a ticket.', 'Chiens autorisÃ©s dans le mÃ©tro et les bus en transporteur ou en laisse.'),
  ('london', 'London', 'Londres', 'United Kingdom', 'GB', 'Europe/London', 'GBP', 51.5074, -0.1278, 12, ARRAY['en'], 'Find dog-friendly pubs, parks, and cafÃ©s across London. One of the most dog-loving cities in the world.', 'Trouvez les pubs, parcs et cafÃ©s accueillant les chiens Ã  Londres.', 'https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?auto=format&fit=crop&w=1600&q=80', true, 'emergency vet London UK', true, true, 'Dogs allowed on most public transport. Must be on leash on buses; carried on escalators.', 'Chiens autorisÃ©s dans la plupart des transports en commun.'),
  ('losangeles', 'Los Angeles', 'Los Angeles', 'United States', 'US', 'America/Los_Angeles', 'USD', 34.0522, -118.2437, 11, ARRAY['en'], 'Discover dog-friendly beaches, hikes, and restaurants across LA. Sun, surf, and pups!', 'DÃ©couvrez les plages, sentiers et terrasses accueillant les chiens Ã  Los Angeles.', 'https://images.unsplash.com/photo-1534190760961-74e8c1c5c3da?auto=format&fit=crop&w=1600&q=80', true, 'emergency vet Los Angeles California', true, true, 'Dogs allowed on Metro buses and trains. Must be in a carrier that fits on your lap.', 'Chiens autorisÃ©s dans les bus et trains Metro en transporteur.'),
  ('newyork', 'New York', 'New York', 'United States', 'US', 'America/New_York', 'USD', 40.7128, -74.0060, 12, ARRAY['en'], 'Find dog-friendly restaurants, parks, and hotels in the Big Apple.', 'Trouvez les restaurants, parcs et hÃ´tels accueillant les chiens Ã  New York.', 'https://images.unsplash.com/photo-1496442226666-8d4d0e62e6e9?auto=format&fit=crop&w=1600&q=80', true, 'emergency vet New York City', true, true, 'Dogs in carriers allowed on subway and buses. Service dogs always welcome.', 'Chiens en transporteur autorisÃ©s dans le mÃ©tro et les bus.'),
  ('barcelona', 'Barcelona', 'Barcelone', 'Spain', 'ES', 'Europe/Madrid', 'EUR', 41.3874, 2.1686, 13, ARRAY['en','es'], 'Explore dog-friendly beaches, tapas bars, and parks in sunny Barcelona.', 'Explorez les plages, bars Ã  tapas et parcs accueillant les chiens Ã  Barcelone.', 'https://images.unsplash.com/photo-1583422409516-2895a77efded?auto=format&fit=crop&w=1600&q=80', true, 'urgencias veterinarias Barcelona EspaÃ±a', true, true, 'Small dogs in carriers allowed on metro. Larger dogs allowed during off-peak hours.', 'Petits chiens en transporteur autorisÃ©s dans le mÃ©tro.'),
  ('sydney', 'Sydney', 'Sydney', 'Australia', 'AU', 'Australia/Sydney', 'AUD', -33.8688, 151.2093, 12, ARRAY['en'], 'Find dog-friendly beaches, parks, and cafÃ©s in beautiful Sydney.', 'Trouvez les plages, parcs et cafÃ©s accueillant les chiens Ã  Sydney.', 'https://images.unsplash.com/photo-1506973035872-a4ec16b8e8d9?auto=format&fit=crop&w=1600&q=80', true, 'emergency vet Sydney Australia', true, true, 'Dogs in carriers allowed on trains and buses outside peak hours. Guide dogs always welcome.', 'Chiens en transporteur autorisÃ©s dans les trains et bus hors heures de pointe.'),
  ('tokyo', 'Tokyo', 'Tokyo', 'Japan', 'JP', 'Asia/Tokyo', 'JPY', 35.6762, 139.6503, 12, ARRAY['en','ja'], 'Find dog-friendly cafes, parks, and shops across Tokyo.', 'Trouvez les cafÃ©s, parcs et boutiques accueillant les chiens Ã  Tokyo.', 'https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?auto=format&fit=crop&w=1600&q=80', true, 'emergency vet Tokyo Japan', true, false, 'Small dogs in carriers allowed on most trains. Some rail lines have size restrictions.', 'Petits chiens en transporteur autorisÃ©s dans la plupart des trains.');
