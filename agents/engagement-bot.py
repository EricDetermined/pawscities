...
CITY_SIGNALS = {
    ...
    "barcelona": ["barcelona", "bcn", "cataluña", "catalunya", "catalonia",
                  "gràcia", "gracia bcn", "eixample", "poblenou", "barceloneta",
                  "montjuïc", "montjuic", "el born", "gòtic", "gotic"],
    "paris": ["paris", "parisien", "parisienne", "montmartre", "marais",
              "île saint-louis", "ile saint-louis"],
    "tokyo": ["tokyo", "東京", "渋谷", "新宿", "代々木", "お台場", "東京犬",
              "吉祥寺", "中目黒", "世田谷", "駒沢公園", "井の頭公園", "飛鳥山",
              "浅草", "上野公園", "池袋", "銀座", "表参道", "原宿", "恵比寿",
              "白金", "六本木", "自由が丘", "二子玉川"],
    ...
    "geneva": ["geneva", "genève", "geneve", "genf", "lac léman", "lake geneva",
               "carouge", "eaux-vives", "plainpalais", "pâquis", "paquis",
               "bains des pâquis", "parc bertrand", "jet d'eau", "champel",
               "servette", "plan-les-ouates", "versoix"],
